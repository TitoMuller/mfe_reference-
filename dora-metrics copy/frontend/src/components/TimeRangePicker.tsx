  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        type="button"
        className={cn(
          "flex h-10 w-full items-center justify-between rounded-md border bg-gray-900 px-3 py-2 text-sm transition-colors",
      ...
      >
        ...
        <ChevronDown 
          className={cn(
            "h-4 w-4 transition-transform text-white ml-2",
            isOpen && "rotate-180"
          )}
        />
      </button>
